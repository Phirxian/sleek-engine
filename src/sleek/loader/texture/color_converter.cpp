...
namespace sleek
{
    namespace loader
    {
        void convert1BitTo16Bit(const u8* in, s16* out, s32 width, s32 height, s32 linepad, bool flip)
        {
            if (!in || !out)
                return;
        ...
        void convert4BitTo16Bit(const u8* in, s16* out, s32 width, s32 height, const s32* palette, s32 linepad, bool flip)
        {
            if (!in || !out || !palette)
                return;
            ...
            for (s32 y=0; y<height; ++y)
            {
                ...
                for (s32 x=0; x<width; ++x)
                {
                    out[x] = math::X8R8G8B8toA1R5G5B5(palette[(u8)((*in >> shift) & 0xf)]);
        ...
        void convert8BitTo16Bit(const u8* in, s16* out, s32 width, s32 height, const s32* palette, s32 linepad, bool flip)
        {
            if (!in || !out || !palette)
                return;
            ...
            for (s32 y=0; y<height; ++y)
            {
                ...
                for (s32 x=0; x<width; ++x)
                {
                    out[x] = math::X8R8G8B8toA1R5G5B5(palette[(u8)(*in)]);
                    ++in;
                }
                if (!flip)
                    out += width;
        ...
        void convert8BitTo24Bit(const u8* in, u8* out, s32 width, s32 height, const u8* palette, s32 linepad, bool flip)
        {
            if (!in || !out )
                return;
        ...
        void convert8BitTo32Bit(const u8* in, u8* out, s32 width, s32 height, const u8* palette, s32 linepad, bool flip)
        {
            if (!in || !out )
                return;
        ...
        void convert16BitTo16Bit(const s16* in, s16* out, s32 width, s32 height, s32 linepad, bool flip)
        {
            if (!in || !out)
                return;
            ...
            for (s32 y=0; y<height; ++y)
            {
                ...
                #else
                   std::memcpy(out, in, width*sizeof(s16));
                #endif
                if (!flip)
                    out += width;
                in += width;
        ...
        void convert24BitTo24Bit(const u8* in, u8* out, s32 width, s32 height, s32 linepad, bool flip, bool bgr)
        {
            if (!in || !out)
                return;
        ...
        void convert16bitToA8R8G8B8andResize(const s16* in, s32* out, s32 newWidth, s32 newHeight, s32 currentWidth, s32 currentHeight)
        {
        ...
        void convert32BitTo32Bit(const s32* in, s32* out, s32 width, s32 height, s32 linepad, bool flip)
        {
            if (!in || !out)
                return;
        ...
        void convert_A8R8G8B8toA1R5G5B5(const void* sP, s32 sN, void* dP)
        {
            ...
            for (s32 x = 0; x < sN; ++x)
                *dB++ = math::A8R8G8B8toA1R5G5B5(*sB++);
        }

        void convert_A8R8G8B8toA1B5G5R5(const void* sP, s32 sN, void* dP)
        {
            u8 * sB = (u8 *)sP;
            u16* dB = (u16*)dP;
        ...
        void convert_B8G8R8A8toA8R8G8B8(const void* sP, s32 sN, void* dP)
        {
            u8* sB = (u8*)sP;
            u8* dB = (u8*)dP;
        ...
        void convert_A8R8G8B8toA8B8G8R8(const void* sP, s32 sN, void* dP)
        {
