...
namespace sleek
{
    ...
    namespace loader
    {
        ...
        bool textureloader_tga::write(driver::texture *img, io::filewriter *file) const noexcept
        {
            #ifdef texture_loader_tga_support
        ...
        bool textureloader_tga::match(const std::string &filename) const noexcept
        {
